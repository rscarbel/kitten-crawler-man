...
import type { Plane, Point, Quad } from './projection';
import {
  ALPHA,
  isOpaque,
  multiplyPixel,
...
import { getRamp, luminance, rgba, sampleRamp, type RGB } from './ramps';
...
export function paintStructuralLine(ctx: Ctx, from: Point, to: Point): void {
