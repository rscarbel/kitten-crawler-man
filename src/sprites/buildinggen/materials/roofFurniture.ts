...
import { paintEdgeLight, paintRecessAo, paintStructuralLine, paintWindowGlow } from '../lighting';
import type { Point, Projection, Quad } from '../projection';
import { getRamp, hueShift, rgb, rgba, sampleRamp, type RGB, type Ramp } from '../ramps';
import type { BuildingSpec, ChimneySpec, DormerSpec } from '../spec';
import { elementValue } from './kit';
import { roofSagPx } from './roof';
 ...
 */
function paintChimneyRoofShadow(ctx: Ctx, projection: Projection, geometry: ChimneyGeometry): void {
...
function paintCap(ctx: Ctx, geometry: ChimneyGeometry, ramp: Ramp): void {
...
function paintPots(ctx: Ctx, geometry: ChimneyGeometry, ramp: Ramp): void {
...
function paintPot(ctx: Ctx, geometry: ChimneyGeometry, ramp: Ramp, left: number): void {
...
function paintDormerCastShadow(ctx: Ctx, body: Rect, gableHeight: number, overhang: number): void {
...
function paintDormerWindow(ctx: Ctx, spec: BuildingSpec, dormer: DormerSpec, body: Rect): void {
