...
import { frameYToFacadePlaneY, groundHeightToFrameY, tileColumnToPlaneX } from '../projection';
import { getRamp, hueShift, rgb, rgba, sampleRamp, type Ramp } from '../ramps';
import type { BuildingSpec, WindowInterior, WindowSpec, WindowStyle } from '../spec';
 ...
 */
function paintDarkGlass(ctx: Ctx, glass: Rect): void {
...
function paintInterior(ctx: Ctx, seed: number, glass: Rect, interior: WindowInterior): void {
...
function paintGoods(ctx: Ctx, seed: number, glass: Rect): void {
...
function paintCrowd(ctx: Ctx, seed: number, glass: Rect): void {
...
function paintBottles(ctx: Ctx, seed: number, glass: Rect): void {
...
function paintFlashArt(ctx: Ctx, seed: number, glass: Rect): void {
...
function paintSleepingCat(ctx: Ctx, glass: Rect): void {
 ...
 */
function paintSpandrels(ctx: Ctx, glass: Rect, light: (target: Ctx) => void): void {
  ctx.save();
  ctx.beginPath();
  ctx.rect(glass.x, glass.y, glass.width, glass.height);
  light(ctx);
...
function paintGlazingBars(ctx: Ctx, glass: Rect, style: WindowStyle): void {
 ...
 */
function paintFrameAndSill(ctx: Ctx, glass: Rect, facadeBaseY: number): number {
 ...
 */
function paintShutters(ctx: Ctx, noise: NoiseField, seed: number, glass: Rect, ramp: Ramp): void {
