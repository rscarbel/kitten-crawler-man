...
/**
 * Draws Mordecai as a Bugaboo for floor 2 — enormous bear-shaped body with no neck,
 * huge owl-like eyes, comically skinny legs, absurdly thin arms, obsidian-colored hair.
 * Both terrifying and cartoonish.
 */
...
export function drawMordecaiForLevel(
  ...
  if (levelId === 'level3') {
    ...
    drawBugabooMordecaiSprite(ctx, sx, sy, s, walkTime, isWalking, facingX);
  } else {
