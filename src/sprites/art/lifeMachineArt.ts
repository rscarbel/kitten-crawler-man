...
/** Where the three panel lamps sit; exported so the gate can read them one by one. */
export const LED_Y = PANEL_BOTTOM_Y - 11;
const LED_R = 2.6;
export const LED_COUNT = 3;
export const LED_SPACING = 8;
export const LED_FIRST_X = PANEL_X0 + 7;
