/**
 * Procedural art for the Grotesque Spider spit attack effects:
...
/** How far the trailing droplet lags sideways over the wobble cycle. */
const PROJECTILE_DROP_WOBBLE_X = 0.03;
...
export function drawSpitProjectile(
  ...
  const dropX =
    cx - rx * PROJECTILE_DROP_TRAIL_RATIO + Math.sin(wobble) * ts * PROJECTILE_DROP_WOBBLE_X;
