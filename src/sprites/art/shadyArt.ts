 ...
 * type; the choreography lives in `shadyFigure.ts`.
 *
 ...
 * down the screen, so heights are negative. The caller scales the whole figure
 * into its cell; nothing here knows about pixels.
 */
