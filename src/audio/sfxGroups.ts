...
export const SFX_GROUPS: Record<SfxGroup, readonly SoundId[]> = {
  ...
  universal: [
    ...
    'wood_smashing_1',
    'wood_smashing_2',
    // Reward flow, timers, save chime and the pet's happy squawks: any floor can fire them.
    'coin_land_tick',
    'garbage_bag_burst_1',
    'garbage_bag_burst_2',
  ...
  briarHollow: [
    ...
    'necromancer_bolt',
    'necromancer_death',
    'necromancer_pulse_charge',
    'necromancer_pulse_release',
    'necromancer_raise',
    'raised_ratkin_death',
    'raised_ratkin_groan',
    'ratkin_chatter_1',
