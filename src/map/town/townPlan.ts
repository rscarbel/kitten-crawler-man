...
const PLANNED_BUILDINGS: ReadonlyArray<PlannedBuilding> = [
  ...
  },
  {
    ...
    frontRow: GARRISON_BOTTOM,
    plotTop: GARRISON_TOP,
    spriteKey: 'cartwrights_workshop',
